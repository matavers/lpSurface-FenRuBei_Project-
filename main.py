        ...
        if mesh_algorithm == "obj":
            ...
            if surface_func:
                ...
                if surface_func == "sphere":
                    # 生成球体
                    from utils.spherical_sampler import generate_spherical_grid, save_obj
                    vertices, faces = generate_spherical_grid(resolution * resolution)
                    sphere_path = "temp_sphere.obj"
                    save_obj(vertices, faces, sphere_path)
